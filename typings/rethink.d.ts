...
declare module "rethinkdb" {
  ...
  interface Sequence extends Operation<Cursor>, Writeable {
    ...
    merge(f: any):Sequence;

    changes(options?: { squash?: boolean , changefeedQueueSize?: number , includeInitial?: boolean , includeStates?: boolean }): Sequence
  }
  ...
  interface Expression<T> extends Writeable, Operation<T> {
      ...
      match(s: any):Expression<boolean>;
